      ...
      <div className="row mx-3">
        <div className="border-cus col-6">
          <img
            ...
            alt=""
          />
          <div className="research-title">Social Media and Adolescent Mental Health</div>
          ...
          <Link to="https://arxiv.org/pdf/1406.2661.pdf%22%7D" target="_blank" className="btn btn-primary w-100">see more</Link>
        </div>
        <div className="border-cus col-6">
          <img
            className="img-fluid rounded"
            ...
            alt=""
          />
          <div className="research-title">Climate Change and Biodiversity: A Global Meta-analysis</div>
          <div className="research-subtitle">
